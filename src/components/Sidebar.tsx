            ...
            >
                ...
                <div className="p-2 sm:p-3 space-y-1.5 sm:space-y-2 border-b border-sidebar-border">
                    ...
                    <Button
                        ...
                        className={cn(
                            "w-full gap-2 text-xs sm:text-sm h-8 sm:h-10",
                            isDesktopCollapsed ? "md:justify-center md:px-2" : "justify-start"
                        )}
                        variant="outline"
                        title="New Chat"
                    >
                        <FiPlus className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                    ...
                    >
                        ...
                        <span className={cn(isDesktopCollapsed && "md:hidden")}>Create Project</span>
                    </Button>
                    ...
                    <Button
                        ...
                        title="Create Image"
                    >
                        <FiImage className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                        <span className={cn(isDesktopCollapsed && "md:hidden")}>Create Image</span>
                    </Button>
                    ...
                    <Button
                        ...
                        title="Create Video"
                    >
                        <FiVideo className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                        <span className={cn(isDesktopCollapsed && "md:hidden")}>Create Video</span>
                    </Button>
                </div>
                            ...
                            {conversations.length === 0 ? (
                                ...
                                conversations.map((conversation) => (
                                    <div
                                        key={conversation.id}
                                        className={cn(
                                            'group relative flex items-start gap-1.5 sm:gap-2 rounded-md px-2 sm:px-3 py-2 text-xs sm:text-sm cursor-pointer hover:bg-sidebar-accent transition-colors',
                ...
                <div className="p-1.5 sm:p-2 border-t border-sidebar-border space-y-0.5 sm:space-y-1">
                    <Button
                        ...
                        title="Upgrade Plan"
                    >
                        <FiUsers className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                        <span className={cn(isDesktopCollapsed && "md:hidden")}>Upgrade Plan</span>
                    </Button>
