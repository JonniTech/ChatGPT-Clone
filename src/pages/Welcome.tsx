import { FiMessageSquare, FiImage, FiVideo, FiFolderPlus, FiMoon, FiSun } from 'react-icons/fi';
...
export function Welcome() {
    ...
    const features = [
        ...
        },
        {
            icon: FiFolderPlus,
            title: 'Projects',
            description: 'Create AI-powered projects',
            ...
            <header className="sticky top-0 z-30 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="flex h-12 sm:h-14 items-center justify-between px-4 sm:px-6 max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center gap-2">
                        <ChatGPTLogo size="sm" className="text-primary" />
                        <h1 className="text-sm sm:text-base font-semibold">ChatGPT</h1>
                    </div>
                ...
                <div className="max-w-4xl w-full text-center space-y-6 sm:space-y-8">
                    ...
                    <div className="flex justify-center">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-primary/10 flex items-center justify-center">
                            <ChatGPTLogo size="xl" className="text-primary" />
                        </div>
                    </div>
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        ...
                        <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto px-4">
                            Experience the power of AI conversations, image generation, and more. Start chatting now or explore our features.
                        </p>
                    </div>
                    ...
                    <div className="pt-8 sm:pt-12 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                        {features.map((feature) => (
                            <button
                                ...
                                className="p-4 sm:p-6 rounded-xl border border-border bg-card hover:bg-accent transition-colors text-left"
                            >
